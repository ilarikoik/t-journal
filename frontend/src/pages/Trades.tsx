        ...
        >
          <table className="w-full text-sm">
            <thead>
              <tr
                className="text-left"
                style={{ backgroundColor: "#111118", color: "#64748b" }}
              >
                {[
                  "Ticker",
                  "Dir",
            ...
            <tbody>
              {trades.map((t, i) => (
                <tr
                  ...
                  style={{
                    borderColor: "#1e1e2e",
                    backgroundColor: i % 2 === 0 ? "#0a0a0f" : "#111118",
                  }}
                >
                  <td
                  ...
                  <td className="px-4 py-3">
                    <span
                      ...
                      style={{
                        backgroundColor:
                          t.direction === "LONG" ? "#22c55e22" : "#ef444422",
