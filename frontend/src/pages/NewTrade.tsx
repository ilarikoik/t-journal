...
export default function NewTrade() {
  ...
  const set = (k: keyof TradeFormData, v: unknown) =>
    setForm((f) => ({ ...f, [k]: v }));
      ...
      >
        <div className="grid grid-cols-2 gap-4">
          ...
          <Field label="Exit Price">
            <input
              ...
              onChange={(e) => set("exitPrice", parseFloat(e.target.value))}
            />
          </Field>
          <Field label="Shares">
            <input
              ...
              placeholder="100"
              value={form.shares || ""}
              onChange={(e) => set("shares", parseInt(e.target.value))}
            />
          </Field>
          <Field label="Setup Tag">
            <input
              className={inputCls}
              style={inputStyle}
              placeholder="Flag, Bounce, 1D chase..."
              value={form.setupTag}
        ...
        <Field label="Notes">
          <textarea
            ...
            style={inputStyle}
            rows={3}
            placeholder="Miksi otit treidin, mitä mietteitä..."
            value={form.notes}
        ...
        <Field label="Chart Screenshot">
          <div>
            <label
              className="flex items-center justify-center w-full py-2 rounded-lg cursor-pointer text-sm transition-colors hover:opacity-80"
              style={{
